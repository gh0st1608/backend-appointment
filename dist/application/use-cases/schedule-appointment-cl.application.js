...
var ScheduleAppointmentCLUseCase_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ScheduleAppointmentCLUseCase = void 0;
...
let ScheduleAppointmentCLUseCase = ScheduleAppointmentCLUseCase_1 = class ScheduleAppointmentCLUseCase {
    constructor(rdsRepo, eventPublisher) {
        this.rdsRepo = rdsRepo;
        this.eventPublisher = eventPublisher;
        this.logger = new common_1.Logger(ScheduleAppointmentCLUseCase_1.name);
    }
    async execute(payload) {
        ...
        appointment.confirm();
        this.logger.log(`Procesando agendamiento CL: appointmentId=${appointment.properties().appointmentId}`);
        // 3️⃣ Guardar en RDS
...
exports.ScheduleAppointmentCLUseCase = ScheduleAppointmentCLUseCase;
exports.ScheduleAppointmentCLUseCase = ScheduleAppointmentCLUseCase = ScheduleAppointmentCLUseCase_1 = __decorate([
